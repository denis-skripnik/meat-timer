...
assert(main.includes('Три волшебные точки') && main.includes('Валик под поясницей') && main.includes('Валик под грудной клеткой') && main.includes('Валик под шеей'), 'Three-position breathing guide is missing.');
